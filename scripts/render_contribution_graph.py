...
def render_svg(username: str, series: list[tuple[date, int]], total: int, dark: bool) -> str:
    ...
    return "\n".join(
        [
            ...
            f'<text x="{MARGIN_LEFT}" y="24" fill="{strong}" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif" font-size="14" font-weight="600">Contributions · last {DAYS} days</text>',
            f'<text x="{WIDTH - MARGIN_RIGHT}" y="24" text-anchor="end" fill="{text}" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif" font-size="11">{total} contributions</text>',
